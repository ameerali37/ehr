...
public partial class DoctorHome : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                cn.Open();
                SqlCommand cm1 = new SqlCommand("select * from dinfo5 where id='" + a + "'", cn);
                ...
                Label30.Text = dn1.Tables[0].Rows[0].ItemArray.GetValue(5).ToString();
                cn.Close();

                SqlCommand com = new SqlCommand("select * from ddata7 where did='" + a.ToString() + "' and des='nil'", cn);
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    Label14.Text = ds.Tables[0].Rows[0].ItemArray.GetValue(1).ToString();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if ((ds.Tables[0].Rows.Count > 0) && (ds.Tables[0].Rows.Count > i))
            {
                ...
                Label14.Text = ds.Tables[0].Rows[i].ItemArray.GetValue(1).ToString();
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        {
            string a = Session["id"].ToString();
            string ndes = TextBox1.Text;

            SqlCommand cmc1 = new SqlCommand("select * from pinfo5 where id='" + Label14.Text + "'", cn);
            ...
            SqlCommand ecmd = new SqlCommand("update ddata7 set des='" + ndes + "' where did='" + a + "' and pid='" + Label14.Text + "' and cid='" + Label13.Text + "'", cn);
            SqlCommand ecmd2 = new SqlCommand("update pdata7 set des='" + ndes + "' where did='" + a + "' and pid='" + Label14.Text + "' and cid='" + Label13.Text + "'", cn);
            SqlCommand ecmd3 = new SqlCommand("insert into phdata7 values ('" + Label18.Text + "','" + a.ToString() + "','" + Label12.Text + "','" + ndes + "','" + Label14.Text + "','" + Label15.Text + "','" + addr1 + "','" + ct1 + "','" + em1 + "','0','"+Label13.Text+"')", cn);
    ...
    protected void lblS5_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            Response.Redirect(lblS5.ImageUrl);
            // Response.Redirect(ImageButton1.ImageUrl);
        }
        catch (Exception e1)
        {
    ...
    protected void OboutButton1_Click(object sender, EventArgs e)
    {
        try
        {
            fl1 = ViewState["r"].ToString();
            string bp6 = enclass.encypt1(Label36.Text);
            string pl3 = enclass.encypt1(Label38.Text);
            string rp3 = enclass.encypt1(Label40.Text);
            string tp3 = enclass.encypt1(Label42.Text);
            SqlCommand cmd2 = new SqlCommand("insert into rfddata8 values('" + txt1.Text + "','" + Label11.Text + "','" + Label12.Text + "','" + Label13.Text + "','" + Label14.Text + "','" + Label15.Text + "','" + Label32.Text + "','" + Label16.Text + "','" + Label31.Text + "','" + Label18.Text + "','" + bp6 + "','" + pl3 + "','" + rp3 + "','" + tp3 + "','" + fl1 + "','" + TextBox1.Text + "','nil','0')", cn);
            cn.Open();
