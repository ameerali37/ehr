...
public partial class LaboratoryRegister : System.Web.UI.Page
{
    int cnt;
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            cn.Open();
            SqlCommand cmd = new SqlCommand("select count(*) from linfo5", cn);
    ...
    protected void btn1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cn.Open();
            SqlCommand cmd = new SqlCommand("insert into linfo5 values('" + cnt1 + "','" + ln.Text + "','" + ad.Text + "','" + em.Text + "','" + ct.Text + "','" + un.Text + "','" + pw.Text + "')", cn);
