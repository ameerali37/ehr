...
public partial class PatientRegister : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            cn.Open();
            SqlCommand cmd = new SqlCommand("select count(*) from pinfo5", cn);
    ...
    protected void btn1_Click(object sender, EventArgs e)
    {
        try
        {
           // DateTime d1 = CalendarExtender1.SelectedDate.Value;
            ...
            else
            {
                ...
                string pic2 = "p" + cnt1 + FileUpload1.FileName;

                cn.Open();
                SqlCommand cmd = new SqlCommand("insert into pinfo5 values('" + cnt1 + "','" + pn.Text + "','" + ad.Text + "','" + em.Text + "','" + ct.Text + "','" + un.Text + "','" + pw.Text + "','" + TextBox1.Text + "','" + pic2 + "')", cn);
